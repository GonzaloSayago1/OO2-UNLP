...
class EmpresaTest {
	...
	void testcalcularMontoTotalLlamadas() {
		ClienteFisico emisorPersonaFisca = sistema.registrarClienteFisico("11555666", "Brendan Eich");
		ClienteFisico remitentePersonaFisica = sistema.registrarClienteFisico("00000001", "Doug Lea");
		ClienteJuridico emisorPersonaJuridica = sistema.registrarClienteJuridico("17555222", "Nvidia Corp");
		ClienteJuridico remitentePersonaJuridica = sistema.registrarClienteJuridico("25765432", "Sun Microsystems");
